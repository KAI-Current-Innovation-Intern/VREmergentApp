  ...
  public class TeleportController : MonoBehaviour {
    ...
    private bool HandlePlayerRotations() {
      ...
      if (rotateLeftTrigger != null && rotateLeftTrigger.TriggerActive()) {
                ...
                //{
                //Transform new_trans =   GetControllerTransform();
                //GameObject TreeSpawner = Instantiate(TreeSpawnerPreFab, new Vector3(hit.point.x, hit.point.y, hit.point.z), new Quaternion());
                ...
                // When trigger deactivates we finish the teleport.
                        ...
                        Vector3 nextPlayerPosition = new Vector3(
                          selectionResult.selection.x,
                          selectionResult.selection.y,
                          selectionResult.selection.z);

                        GameObject TreeSpawner = Instantiate(TreeSpawnerPreFab, nextPlayerPosition, new Quaternion());
