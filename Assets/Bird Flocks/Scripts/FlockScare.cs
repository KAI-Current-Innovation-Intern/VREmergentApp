...
public class FlockScare : MonoBehaviour {
	...
	public float scareInterval = 0.01f;                         //How often to check the next spot if it is close enough to scare (Every Nth second)
	public float distanceToScare = 30;                          //How far from a landingspot this transform can call scare function
	...
	public int InvokeAmounts = 5;                              //How many instances of Invokes to run (Only go above 1 when more controllers than the Interval can handle) 
